...
fn main() {
    ...
    //TODO : Get deployment txs and block number 
    generate_contract_with_config("BCowHelper", |builder| {
        builder
            .add_network(
                MAINNET,
                Network {
                    address: addr("0x03362f847b4fabc12e1ce98b6b59f94401e4588e"),
                    // <https://etherscan.io/tx/>
                    deployment_information: Some(DeploymentInformation::BlockNumber(00000000)),
                },
            )
            .add_network(
                GNOSIS,
                Network {
                    address: addr("0xdb2aeab529c035469e190310def9957ef0398ba8"),
            ...
            .add_network(
                BASE,
                Network {
                    address: addr("0x467665D4ae90e7A99c9C9AF785791058426d6eA0"),
                    // <https://basescan.io/tx/>
                    deployment_information: Some(DeploymentInformation::BlockNumber(00000000)),
                },
            )
    });
